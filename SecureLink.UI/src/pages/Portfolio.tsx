...
const projects = [
  {
    ...
    description: 'Face recognition powered photo search. Upload event photos, find yourself using just a selfie.',
  ...
  },
  {
    ...
    description: 'Real-time infrastructure monitoring with beautiful terminal aesthetics.',
  ...
  },
  {
    ...
    description: 'Real-time collaborative code editor with video chat integration.',
...
const adventures = [
  ...
  },
  {
    icon: '🏃',
    title: 'RUNNING',
    description: 'Half marathons completed: 3. Full marathons: still loading...',
  },
  {
    icon: '⛰️',
    title: 'TREKKING',
    ...
    <div className="min-h-screen bg-background scanlines">
            ...
            <div className="flex-1">
              <div className="terminal-card p-6 sm:p-8 glow-primary">
                ...
                <p className="font-mono text-muted mt-4">
                  <TypewriterText text="4 years shipping products, breaking things, fixing them." delay={1500} />
                </p>
                <p className="font-mono text-secondary mt-4">
                  <TypewriterText text="Currently: Looking for my next quest 🗺️" delay={2500} />
                </p>
              </div>
            </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="terminal-card p-6 sm:p-8">
            ...
            <p className="font-mono text-foreground leading-relaxed mb-6">
              I build things that live on the internet. From robust backend systems to 
              pixel-perfect frontends, I enjoy the entire spectrum of web development. 
              When I&apos;m not debugging production issues at 2 AM, you&apos;ll find me exploring 
              new tech, contributing to open source, or pretending I understand 
              distributed systems.
            </p>
            ...
            {projects.map((project) => (
              <div
                ...
                className={cn(
                  ...
                  project.featured && 'md:col-span-2 lg:col-span-1 border-primary'
                )}
              >
                {project.featured && (
                ...
                <p className="font-mono text-xs text-secondary mb-3">{project.tagline}</p>
      ...
      <section id="adventures" className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="font-mono text-sm text-muted mb-8">// because devs have lives too</p>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            {adventures.map((adventure) => (
              ...
              >
                ...
                <p className="font-mono text-sm text-muted">{adventure.description}</p>
